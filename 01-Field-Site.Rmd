...
We used high-accuracy and durable TOMST TMS-4 dataloggers to record microclimate site temperature and soil moisture (Wild et al., 2019). These 30 cm long loggers have three thermistors at +15 (near-surface), 0 (surface), and -8 cm (soil) relative to the ground surface. 
...
A study conducted in 2004 discusses that site types present in Alex Fraser Research Forest. Site descriptions are included in the study [@klinkaSiteUnitsUniversity2004]. See Figure \@ref(fig:Ext) for plots of what the data should look like. 
...
Landsat derived difference in Normalized Burn Ratio (dNBR) ad calculated from August and October imagery (pre and post fire). Fire severity is linked for 5 different classes where 5 is the highest fire severity. 
...
Also included in the fire severity data is a description of the cutblocks and wildlife tree patches. It is important to note many of these locations have changed in 2020 (as I unfortunately found out)
